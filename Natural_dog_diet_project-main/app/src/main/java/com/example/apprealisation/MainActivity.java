...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Устанавливаем фон из ресурсов drawable
        // Предполагается, что ваше изображение называется "ABC" и находится в res/drawable/
        rootView.setBackgroundResource(R.drawable.wallpapermainactivity);
