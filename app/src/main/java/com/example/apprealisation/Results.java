...
public class Results extends AppCompatActivity {
    ...
    public static String analyzeDogDiet(double[] nutrients) {
        ...
        return String.format(
                "Согласно проведённому расчёту нынешней диеты вашей собаки, вашему питомцу необходимо потреблять на: " +
                        " %s полезных веществ в день, %s белков, %s жиров, %s углеводов, %s клетчатки.",
